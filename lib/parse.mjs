...
const CAT_RULES = [
  ...
  ["collectibles", /\b(lego|warhammer|age of sigmar|sigmar|slaanesh|games workshop|citadel|gundam|airfix|model kit|pok[eé]mon|pikachu|charizard|tcg|trading card|funko|graded|psa ?10|gem ?mint|holo|slab|miniature|collectible)\b/i],
