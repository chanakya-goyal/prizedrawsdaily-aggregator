...
const CAT_KW = {
  "car-draws": /\b(car|van|bike|motor|audi|bmw|mercedes|porsche|ford|vw|golf|tesla|ferrari|lamborghini|range rover|defender|vehicle|supercar|campervan)\b/i,
  "house-draws": /\b(house|home|flat|apartment|bungalow|property|villa|mortgage)\b/i,
  "tech-giveaways": /\b(iphone|ipad|macbook|laptop|pc|ps5|playstation|xbox|nintendo|switch|console|tv|gpu|rtx|gaming|airpods|drone|gadget|samsung)\b/i,
  "luxury": /\b(rolex|omega|watch|jewellery|jewelry|diamond|designer|holiday|getaway|tackle|fishing|carp|handbag|chanel|gucci|louis vuitton)\b/i,
  "collectibles": /\b(lego|warhammer|sigmar|slaanesh|games workshop|citadel|gundam|model kit|pok[eé]mon|tcg|trading card|funko|graded|holo|slab|collectible)\b/i,
