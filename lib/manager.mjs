...
const CAT_KW = {
  ...
  "luxury": /\b(rolex|omega|watch|jewellery|jewelry|diamond|designer|holiday|getaway|tackle|fishing|carp|pok[eé]mon|tcg|trading card|funko|collectible|handbag|chanel|gucci|louis vuitton)\b/i,
