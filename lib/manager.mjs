...
export function fieldFlags(draw) {
  ...
  // DIFFERENT category. Silence is not contradiction: plenty of legitimate prizes (a Dewalt
  // tool kit, a detailing bundle, "The £2 Million Summer Clear-Out") match no keyword at all,
