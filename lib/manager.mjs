...
const CAT_KW = {
  ...
  "luxury": /\b(rolex|omega|tudor|breitling|tag ?heuer|cartier|watch|jewellery|jewelry|diamond|designer|holiday|getaway|cruise|hot ?tub|lay-?z-?spa|jacuzzi|spa|champagne|prosecco|whisky|whiskey|perfume|aftershave|fragrance|sunglasses|ray-?ban|tackle|fishing|carp|handbag|chanel|gucci|louis vuitton|prada|dior|burberry|hermes|taylormade|callaway|titleist|mizuno|powakaddy|motocaddy|odyssey|golf club|putter|fairway wood|driving iron|golf trolley|golf bag|golf balls?)\b/i,
  "collectibles": /\b(lego|warhammer|sigmar|slaanesh|nighthaunt|stormcast|astra militarum|space marines?|necrons?|tyranids?|horus heresy|kill team|games workshop|citadel|gundam|model kit|pok[eé]mon|tcg|trading cards?|lorcana|magic the gathering|\bmtg\b|yu-?gi-?oh|funko|graded|holo|slab|collectible|booster|elite trainer|sealed)\b/i,
